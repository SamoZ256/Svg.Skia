...
// ExprHelpers is the text of the runtime helpers the generated code calls. The evaluator's
// differential test compiles that text and runs it against the evaluated value, so it has to use
// the real bodies rather than a copy of them — a copy would drift and quietly stop testing anything.
