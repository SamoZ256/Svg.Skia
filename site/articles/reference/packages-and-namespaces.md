...
| [SvgML.Maui](../packages/svgml-maui) | `SvgML` | Inline .NET MAUI XAML SVG element tree and `foreignObject` native-control hosting |
| [SvgML.Uno](../packages/svgml-uno) | `SvgML` | Inline Uno Platform XAML SVG element tree and `foreignObject` native-control hosting |
